export const CATEGORIES = [
  ...
  { id: 'parking',    label: 'Parking',    emoji: '🅿️', color: '#868e96', icon: 'car' },
  { id: 'home',       label: 'Maison',     emoji: '🏠', color: '#ff922b', icon: 'home' },
  { id: 'other',      label: 'Autre',      emoji: '📍', color: '#6366f1', icon: 'location' },
];
